		...
		public static void Deserialize( ProbabilityReward ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80001:
                	{
						ins.Type = reader.ReadEnum<TypeGameItem>();
                	}
                	break; 
                	case 0x10002:
                	{
		...
		public static void Deserialize( DealDemand ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80001:
                	{
						ins.Level = reader.ReadEnum<TypeRarity>();
                	}
                	break; 
                	case 0x80002:
                	{
						ins.Type = reader.ReadEnum<CropType>();
                	}
                	break; 
                }
             }
		...
		public static void Deserialize( TaskDefine ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80001:
                	{
						ins.TaskType = reader.ReadEnum<TaskType>();
                	}
                	break; 
                	case 0x70002:
                	{
                	...
                	case 0x80008:
                	{
						ins.SceneTag = reader.ReadEnum<TaskSceneTag>();
                	}
                	break; 
                	case 0x60009:
                	{
		...
		public static void Deserialize( StoreDefine ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80001:
                	{
						ins.MallType = reader.ReadEnum<ShopItemType>();
                	}
                	break; 
                	case 0x10002:
                	{
		...
		public static void Deserialize( ServerErrorCodeDefine ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80001:
                	{
						ins.errorCode = reader.ReadEnum<WebErrorCode>();
                	}
                	break; 
                	case 0x70002:
                	{
		...
		public static void Deserialize( ManorCropDefine ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x8000a:
                	{
						ins.CropType = reader.ReadEnum<CropType>();
                	}
                	break; 
                	case 0x1000b:
                	{
                	...
                	case 0x8000c:
                	{
						ins.Rarity = reader.ReadEnum<TypeRarity>();
                	}
                	break; 
                }
             }
		...
		public static void Deserialize( DataAnalyticsDefine ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80001:
                	{
						ins.EventMainId = reader.ReadEnum<DotEventMainId>();
                	}
                	break; 
                	case 0x80002:
                	{
						ins.EventSubId = reader.ReadEnum<DotEventId>();
                	}
                	break; 
                	case 0x60003:
                	{
		...
		public static void Deserialize( CostumeDefine ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80002:
                	{
						ins.Type = reader.ReadEnum<CostumeType>();
                	}
                	break; 
                	case 0x80003:
                	{
		...
		public static void Deserialize( ChapterDialogueTextDefine ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80005:
                	{
						ins.BoxType = reader.ReadEnum<DialogueType>();
                	}
                	break; 
                	case 0x70006:
                	{
		...
		public static void Deserialize( DecorateDefine ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80001:
                	{
						ins.DecorateType = reader.ReadEnum<TypeManorDecorate>();
                	}
                	break; 
                	case 0x60002:
                	{
		...
		public static void Deserialize( GameItemDefine ins, tabtoy.DataReader reader )
		{
            ...
            while ( -1 != (tag = reader.ReadTag()))
            {
                ...
                { 
                	...
                	case 0x80003:
                	{
						ins.ItemType = reader.ReadEnum<TypeGameItem>();
                	}
                	break; 
                	case 0x80004:
                	{
						ins.KnapsackType = reader.ReadEnum<KnapsackType>();
                	}
                	break; 
                	case 0x80005:
                	{
                	...
                	case 0x80009:
                	{
						ins.Use = reader.ReadEnum<GoodsUseType>();
                	}
                	break; 
                	case 0x7000a:
                	{
